...
instrument1 = AudioSegment.from_file("dataset\Animals\Anis\Final\output-bird.wav", format="wav")
instrument2 = AudioSegment.from_file("dataset\Animals\Anis\Final\output-cat.wav", format="wav")
instrument3 = AudioSegment.from_file("dataset\Animals\Anis\Final\output-cow.wav", format="wav")
instrument4 = AudioSegment.from_file("dataset\Animals\Anis\Final\output-dog.wav", format="wav")
...
combined.export("dataset/Animals/CocktailAnimal.wav", format="wav")